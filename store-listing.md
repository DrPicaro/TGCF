...
- Comparte el resultado cuando tú lo decidas.
- Funciona sin cuenta y sin enviar tus marcas a ningún servidor.

Los cálculos se basan en el Anexo II de la Orden DEF/15/2026. Consulta siempre la normativa oficial vigente y las condiciones concretas de tu convocatoria.

## Categoría sugerida
Educación / Herramientas

## URLs que habrá que introducir

- Política de privacidad: `https://drpicaro.github.io/TGCF/privacy.html` (sustituir por dominio oficial de MCF si se configura).
- Soporte: pendiente de correo oficial de MCF.
- Web del desarrollador: pendiente de URL oficial de MCF.

## Pendientes antes de enviar a revisión

- Confirmar nombre legal y correo de soporte de MCF.
- Preparar capturas reales en Android y iPhone.
